...
const BASE_URL = "https://arroyobus.net";
    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/avisos/san-antonio", changefreq: "yearly", priority: "0.5" },
          { path: "/buses", changefreq: "daily", priority: "0.7" },
          { path: "/paradas", changefreq: "weekly", priority: "0.7" },
